...
def slowprint(s):
    for c in s + '\n':
        ...
        sys.stdout.flush()
        time.sleep(3. / 100)
slowprint("\t\t                                         \033[93mBy :LuCiD1774\033[97m")
print(" ")
...
if L==('2') :
               ...
               print("\033[94m2 \033[97m- \033[91meth0 \033[97m( CABLE connection)")
               print(" ")
               C=input("   \033[95m[?] \033[97menter your \033[91mconnection type \033[97m:")
               if C==('2') :
                        slowprint("")
...
if L==('4'): 
               ...
               print("\033[94m2 \033[97m- \033[91meth0 \033[97m( CABLE connection)")
               print(" ")
               i=input("   \033[95m[?] \033[97menter your \033[91mconnection type \033[97m:")
               if i==('2') :
                        print(" ")
                        slowprint("\033[97m")
...
if L==('3'):
               ...
               print("\033[94m2 \033[97m- \033[91meth0 \033[97m( CABLE connection)")
               print(" ")
               D=input("   \033[95m[?] \033[97menter your \033[91mconnection type \033[97m:")
               if D==('2') :
                        print(" ")
                        os.system('ifconfig eth0 down')
